...
// Query to get catalog items with likes between 50 and the maximum
$query = "SELECT id, image, title, likes FROM catalog WHERE likes >= 50 ORDER BY likes DESC";
